...
```text
├── Hardware/
│   ├── PDB_Core_6S2P_v1.8.PrjPcb    # Main Altium project
│   ├── PDB_Schematic_v1.8.SchDoc    # Schematic document
│   └── PDB_Layout_2oz_v1.8.PcbDoc   # PCB layout document
├── Libraries/
│   ├── PDB_Components_v1.8.SchLib   # Custom SCH library
│   └── PDB_Footprints_v1.8.PcbLib   # Custom PCB footprint library
├── Manufacturing/
│   └── Gerber_NC_Drill_v1.8.rar     # Production files
├──Simulations/
